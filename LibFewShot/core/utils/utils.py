...
def get_instance(module, name, config_dict, **kwargs):
    """
    ...
    """
    if config_dict[name]["kwargs"] is not None:
        kwargs.update(config_dict[name]["kwargs"])

    return getattr(module, config_dict[name]["name"])(**kwargs)
